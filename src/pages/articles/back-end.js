...
export default function FrontEnd() {
  ...
  const meta = {
    ...
    description:
      ...
      " - " +
      "Want to read some articles about Back-End Development? Look no further, here are some articles to release the StackOverflow inside of you",
  };
  ...
  return (
    <Layout meta={meta} className="use-temp">
      <PageMeta
        title="Back-End Articles"
        description="Articles to release the StackOverflow inside of you."
        postsRef={posts}
      />
